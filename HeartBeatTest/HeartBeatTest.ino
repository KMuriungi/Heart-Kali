...
int blinkPin = 28;                // pin to blink led at each beat
int fadePin = 24;                  // pin to do fancy classy fading blink at each beat
int fadeRate = 26;                 // used to fade LED on with PWM on fadePin
